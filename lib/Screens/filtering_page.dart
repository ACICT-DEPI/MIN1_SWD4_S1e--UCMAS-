...
class _FilteringPageState extends State<FilteringPage> {
  ...
  Map<String, List<String>> countryCities = {
    ...
    'السعودية': ['الرياض', 'جدة', 'مكة', 'المدينة', 'الدمام', 'الخبر', 'الطائف', 'القصيم'],
    'الإمارات': ['أبو ظبي', 'دبي', 'الشارقة', 'عجمان', 'رأس الخيمة', 'الفجيرة', 'أم القيوين'],
    'الأردن': ['عمان', 'الزرقاء', 'إربد', 'العقبة', 'مأدبا', 'الكرك', 'الطفيلة', 'جرش'],
  };
                        ...
                        const TableRow(
                          ...
                          children: [
                            Padding(
                              ...
                              child: Text('الرتبة', style: TextStyle(color: Colors.white)),
                            ),
                            Padding(
                              padding: EdgeInsets.all(8.0),
                            ...
                            Padding(
                              padding: EdgeInsets.all(8.0),
                              child: Text('الإيميل', style: TextStyle(color: Colors.white)),
                            ),
                          ],
                        ),
                        ...
                        for (var user in users)
                          TableRow(
                            children: [
                              Padding(
                                padding: const EdgeInsets.all(8.0),
                                child: Text((users.indexOf(user) + 1).toString()), 
                              ),
                              Padding(
                                padding: const EdgeInsets.all(8.0),
                                child: InkWell(
